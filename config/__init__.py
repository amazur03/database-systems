...
from admin_view import (
    ...
    UnitModelView,
    UserModelView,
    WarehouseMoveModelView,
    WarehouseMoveProductModelView,
    UserModelView,
    InventoryModelView,
    InventoryProductModelView,
    OperationLogModelView,
)
from controller_view import (
    ControllerInventoryProductModelView,
    ControllerInventoryModelView,
    ControllerWarehouseMoveModelView,
    ControllerWarehouseMoveProductModelView,
    ControllerOperationLogModelView,
    ControllerProductModelView,
)
from warehouseman_view import (
    WarehousemanWarehouseMoveModelView,
    WarehousemanWarehouseMoveProductModelView,
    WarehousemanProductModelView,
)
...
def configure_admin_panel(app):
    admin = Admin(
        app, name="Admin Panel", endpoint="admin", url="/admin"
    )  # The 'Management Panel' will be the name displayed in the admin panel
    ...
    admin.add_view(
        WarehouseMoveModelView(
            WarehouseMove,
            db.session,
            endpoint="admin_warehous_move",
            name="Warehouse Moves",
            category="Warehouse Managment",
        )
    )
    admin.add_view(
        WarehouseMoveProductModelView(
            WarehouseMoveProduct,
            db.session,
            endpoint="admin_warehous_move_prod",
            name="Warehous Moves Products",
            category="Warehouse Managment",
        )
    )
    admin.add_view(
    ...
    admin.add_view(
        InventoryProductModelView(
            InventoryProduct,
            db.session,
            endpoint="admin_inventory_product",
...
def configure_controller_panel(app):
    controller = Admin(
        app, name="Controller Panel", endpoint="controller", url="/controller"
    )  # The 'Management Panel' will be the name displayed in the admin panel
    ...
    controller.add_view(
        ControllerWarehouseMoveModelView(
            WarehouseMove,
            db.session,
            endpoint="controller_warehous_move",
            name="Warehouse Moves",
            category="Warehouse Managment",
        )
    )
    controller.add_view(
        ControllerWarehouseMoveProductModelView(
            WarehouseMoveProduct,
            db.session,
            endpoint="controller_warehous_move_prod",
            name="Warehous Moves Products",
            category="Warehouse Managment",
        )
    )
    controller.add_view(
        ControllerInventoryModelView(
            Inventory,
            db.session,
            endpoint="controller_admin_inventory",
            name="Inventory",
            category="Inventory Managment",
        )
    )
    controller.add_view(
        ControllerInventoryProductModelView(
            InventoryProduct,
            db.session,
            endpoint="controller_inventory_product",
            name="Inventory Products",
            category="Inventory Managment",
        )
    )
    controller.add_view(
        ControllerOperationLogModelView(
            OperationLog,
            db.session,
            endpoint="controller_operation_log",
            name="Operation Logs",
            category="Logs",
        )
    )
...
def configure_warehouseman_panel(app):
    warehouseman = Admin(
        app, name="Warehouseman Panel", endpoint="warehouseman", url="/warehouseman"
    )  # The 'Management Panel' will be the name displayed in the admin panel
    warehouseman.add_link(MenuLink(name="Logout", url="/logout"))
    warehouseman.add_view(
        WarehousemanWarehouseMoveModelView(
            WarehouseMove,
            db.session,
            endpoint="warehouseman_warehous_move",
            name="Warehouse Moves",
            category="Warehouse Managment",
        )
    )
    warehouseman.add_view(
        WarehousemanWarehouseMoveProductModelView(
            WarehouseMoveProduct,
            db.session,
            endpoint="warehouseman_warehous_move_prod",
            name="Warehous Moves Products",
            category="Warehouse Managment",
        )
    )
...
def configure_app(app):
    # Set the secret key to use for the session
