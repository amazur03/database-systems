...
class Unit(db.Model):
    ...
    id = db.Column(db.BigInteger, primary_key=True)  # Unique identifier for each unit
    ...
    products = db.relationship('Product', back_populates='unit')  # Relationship to products
